...
function _getRoutes() {
	...
	resourceNames.forEach(function(resourceName) {
		...
		var restPrefix = controllerConfig.restPrefix ? controllerConfig.restPrefix : _config.blueprints.restPrefix;
		...
		var defaultPrefix = (restPrefix ? restPrefix : prefix) + '/' + (plural ? pluralize(resourceName).lowerFirst() : resourceName.lowerFirst()) //TODO: pluralize
